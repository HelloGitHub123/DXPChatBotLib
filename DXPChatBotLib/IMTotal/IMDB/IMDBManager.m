...
+ (FMDatabaseQueue *)getDBQueue{
    ...
    @synchronized(self) {
        NSString *realPath = [[[self class]  userFilePath] stringByAppendingPathComponent:T_UCC_DB_NAME];
...
+ (void)initDBSettings{
    ...
    [IMDBManager closeDB];
    [IMDBManager reInitDBQueue];
    [IMDBManager initCoreBizDBMigrationManagerSetting];
}
